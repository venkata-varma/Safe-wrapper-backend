        ...
        <table>
            ...
            <tfoot>
                <tr>
                    ...
                    <td>${Math.round((destinationStatusTotalCount/sourceStatusTotalCount)*100) === isNaN(Math.round((destinationStatusTotalCount/sourceStatusTotalCount)*100)) ? 0+'%' : Math.round((destinationStatusTotalCount/sourceStatusTotalCount)*100) + "%"}</td>
                </tr>
            </tfoot>
        </table>
        </div>
